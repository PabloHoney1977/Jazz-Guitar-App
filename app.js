...
function GuideView({openPreset,level,streak,lastPracticeDay,bestStreak,onUpgrade,onPracticed}){
  ...
  const stages=[
    ...
    {id:'blues',phase:'Forms',fullPreset:true,
     ...
     items:['Loop the Jazz Blues form with shells only — one chord per bar, focus on landing in time','Identify the ii–V–I in bars 9–11 — it\'s the same progression you already know','Listen to Billie\'s Bounce or Now\'s the Time: can you follow the 12-bar form and hear the ii–V coming?',['Next, try ',term('drop2','Drop 2'),' on bars 1 and 5 first, then gradually through the rest of the form'],'Done when: you can play all 12 bars of a jazz blues in F from memory at a steady tempo, shells all the way through']},
